...
export default {
  ...
  methods: {
    ...
    previewHandle(data) {
        window.open("http://item.mall.com/" + data + ".html");
    },
    //处理更多指令
    handleCommand(row, command) {
      ...
      } else if("seckillSettings" == command) {
        this.$router.push({ path: "/coupon-seckillsession"});
        // window.open("/coupon-seckillsession");
      } else if("reductionSettings" == command) {
        this.$router.push({ path: "/coupon-full"});
        // window.open("/coupon-full");
      } else if("memberPriceSettings" == command) {
        this.$router.push({ path: "/coupon-memberprice"});
        // window.open("/coupon-memberprice");
      } else if("couponSettings" == command) {
        this.$router.push({ path: "/coupon-coupon"});
        // window.open("/coupon-coupon");
      }
    },
    searchSkuInfo() {
      this.getDataList();
