...
CREATE TABLE `sms_category_bounds`  (
  ...
  `grow_bounds` decimal(10, 0) NULL DEFAULT NULL COMMENT '成长积分',
  `buy_bounds` decimal(10, 0) NULL DEFAULT NULL COMMENT '购物积分',
...
-- ----------------------------
INSERT INTO `sms_coupon` VALUES (1, 1, 'https://cdn.rawchen.com/mall/2022-05-20/53d4350f-94b9-4531-8e9a-43b7e95f1fa1_123213.jpg', '10元会员券', 10, 10.0000, 1, 0.0000, '2022-05-20 00:00:00', '2022-06-30 00:00:00', 0, 't', 10, NULL, NULL, '2022-05-20 00:00:00', '2022-06-30 00:00:00', 't', 0, 0);
...
-- ----------------------------
INSERT INTO `sms_seckill_promotion` VALUES (1, '红米 Redmi K50抢购', '2022-04-14 00:00:00', '2022-06-22 00:00:00', 1, NULL, NULL);
...
CREATE TABLE `sms_seckill_session`  (
  ...
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '秒杀活动场次' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of sms_seckill_session
-- ----------------------------
INSERT INTO `sms_seckill_session` VALUES (1, '秒杀', '2022-02-10 00:15:00', '2022-02-11 15:59:51', 1, '2022-04-14 22:34:39');
INSERT INTO `sms_seckill_session` VALUES (2, '秒杀', '2022-02-09 05:15:00', '2022-02-09 15:59:59', 1, '2022-04-14 22:24:32');
INSERT INTO `sms_seckill_session` VALUES (3, '红米 Redmi K50手机抢购', '2022-04-14 00:00:01', '2022-04-14 23:59:59', 1, '2022-04-14 22:21:07');
INSERT INTO `sms_seckill_session` VALUES (4, '秒杀抢购', '2022-05-15 00:00:00', '2022-07-01 23:59:00', 1, '2022-05-14 17:45:23');
...
CREATE TABLE `sms_seckill_sku_relation`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '秒杀活动商品关联' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sms_seckill_sku_relation` VALUES (3, NULL, 3, 37, 2000, 10, 1, 0);
INSERT INTO `sms_seckill_sku_relation` VALUES (4, NULL, 4, 71, 798, 10, 9, 0);
...
CREATE TABLE `sms_sku_bounds`  (
  ...
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '商品sku积分设置' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sms_sku_bounds
-- ----------------------------
INSERT INTO `sms_sku_bounds` VALUES (1, 7, 0, 0, 0, NULL, NULL);
INSERT INTO `sms_sku_bounds` VALUES (2, 8, 0, 0, 0, NULL, NULL);
INSERT INTO `sms_sku_bounds` VALUES (3, 9, 0, 0, 0, NULL, NULL);
INSERT INTO `sms_sku_bounds` VALUES (4, 10, 100, 100, 10, NULL, NULL);
INSERT INTO `sms_sku_bounds` VALUES (5, 11, 100, 100, 10, NULL, NULL);
INSERT INTO `sms_sku_bounds` VALUES (6, 12, 200, 200, 5, NULL, NULL);
INSERT INTO `sms_sku_bounds` VALUES (8, 14, 20, 20, 10, NULL, NULL);
INSERT INTO `sms_sku_bounds` VALUES (9, 15, 222, 222, 12, NULL, NULL);
...
CREATE TABLE `sms_spu_bounds`  (
  ...
  `work` tinyint(1) NULL DEFAULT NULL COMMENT '优惠生效情况[1111（四个状态位，从右到左）;0 - 无优惠，成长积分是否赠送;1 - 无优惠，购物积分是否赠送;2 - 有优惠，成长积分是否赠送;3 - 有优惠，购物积分是否赠送【状态位0：不赠送，1：赠送】]',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 12 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '商品spu积分设置' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `sms_spu_bounds` VALUES (5, 7, 3.0000, 3.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (6, 8, 2.0000, 2.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (7, 9, 3.0000, 3.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (8, 10, 3.0000, 3.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (9, 11, 1.0000, 4.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (10, 12, 3.0000, 2.0000, NULL);
INSERT INTO `sms_spu_bounds` VALUES (11, 13, 2.0000, 2.0000, NULL);

-- ----------------------------
-- Table structure for sms_spu_full_reduction
-- ----------------------------
DROP TABLE IF EXISTS `sms_spu_full_reduction`;
CREATE TABLE `sms_spu_full_reduction`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'id',
  `spu_id` bigint(20) NULL DEFAULT NULL COMMENT 'spu_id',
  `full_price` decimal(10, 0) NULL DEFAULT NULL COMMENT '满多少',
  `reduce_price` decimal(10, 0) NULL DEFAULT NULL COMMENT '减多少',
  `add_other` tinyint(1) NULL DEFAULT NULL COMMENT '是否参与其他优惠',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
-- Records of sms_spu_full_reduction
-- ----------------------------

-- ----------------------------
-- Table structure for sms_spu_ladder
-- ----------------------------
...
CREATE TABLE `sms_spu_ladder`  (
  ...
  `spu_id` bigint(20) NULL DEFAULT NULL COMMENT 'spu_id',
  `full_count` int(11) NULL DEFAULT NULL COMMENT '满几件',
  `discount` decimal(10, 0) NULL DEFAULT NULL COMMENT '打几折',
  `price` decimal(10, 0) NULL DEFAULT NULL COMMENT '折后价',
  `add_other` tinyint(1) NULL DEFAULT NULL COMMENT '是否叠加其他优惠[0-不可叠加，1-可叠加]',
  `create_time` datetime(0) NULL DEFAULT NULL COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`id`) USING BTREE
