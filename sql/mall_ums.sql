...
-- ----------------------------
INSERT INTO `ums_member` VALUES (1, 1, 'test', '$2a$10$uDXc05.IsjGI//f7HC8/lOGys0oRiFZX59olzqVqTl8IKxR8iBVGy', 'test', '18173516208', 'xxx@gmail.com', NULL, 0, '2022-06-25', '湖南 长沙', 'JAVA', NULL, NULL, NULL, NULL, 0, '2022-01-25 13:09:14', NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (2, 1, 'sentinel', '$2a$10$j5XRpUeGq7AYIFk7pqdvyebK.Bo5MvasCxk.8RuBWsHFcq5RzXKEC', 'sentinel', '18173516102', 'xxx@gmail.com', NULL, 1, '2022-06-25', '湖南 长沙', 'JAVA', NULL, NULL, NULL, NULL, 0, '2022-01-25 13:15:33', NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (3, 1, 'firenayfly', '$2a$10$UvvfpBagTqbalI6UTnq5nOiPheEdbKLO64fozWMx1lUeK9p2tM366', 'firenayfly', '18467894965', 'xxx@gmail.com', NULL, 1, '2022-06-25', '湖南 长沙', 'JAVA', NULL, NULL, NULL, NULL, 0, '2022-01-25 13:18:32', NULL, NULL, NULL);
INSERT INTO `ums_member` VALUES (4, 1, '汀西氟的我是你', '$2a$10$uDXc05.IsjGI//f7HC8/lOGys0oRiFZX59olzqVqTl8IKxR8iBVGy', '汀西氟的我是你', '18467894965', 'xxx@gmail.com', NULL, 1, '2022-06-26', '湖南 长沙', '自媒体', NULL, NULL, NULL, NULL, 0, '2022-01-26 09:36:00', '5605937365', '2.00b5w4HGMwxc6B0e3d62c666DlN1DD', '157679999');
INSERT INTO `ums_member` VALUES (5, 1, 'rawchen', '$2a$10$vFQSDstOTf8iFsHBEaCf8uDi6.oozT.mgkicd3AXmC2ymVgwY.F8a', 'rawchen', '18255555555', 'xxx@gmail.com', NULL, 1, '2022-03-16', '湖南 长沙', 'JAVA', NULL, NULL, NULL, NULL, 0, '2022-03-16 23:22:58', NULL, NULL, NULL);
...
CREATE TABLE `ums_member_receive_address`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_unicode_ci COMMENT = '会员收货地址' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of ums_member_receive_address
-- ----------------------------
INSERT INTO `ums_member_receive_address` VALUES (1, 1, 'rawchen', '18173516208', NULL, '湖南', '长沙', NULL, '望城区', NULL, 1);
INSERT INTO `ums_member_receive_address` VALUES (2, 2, 'sentinel', '18173516102', NULL, '湖南', '长沙', NULL, '雨花区', NULL, 1);
INSERT INTO `ums_member_receive_address` VALUES (3, 3, 'test', '15421564125', NULL, '陕西', '西安', NULL, '新城区', NULL, 1);
INSERT INTO `ums_member_receive_address` VALUES (4, 5, 'csq', '11231230123', NULL, '福建', '厦门', NULL, '集美区', NULL, NULL);
INSERT INTO `ums_member_receive_address` VALUES (5, 5, '测试收件人', '110', NULL, '福建', '厦门', NULL, '海沧', NULL, NULL);
