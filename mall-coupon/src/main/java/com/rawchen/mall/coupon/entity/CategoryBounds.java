...
/**
 * 商品分类积分设置 [CategoryBounds]数据对象.
 * Created by RawChen on 2021-11-22.
 **/
@ApiModel(value = "CategoryBounds", description = "商品分类积分设置对象")
public class CategoryBounds extends DataEntity<CategoryBounds> implements Serializable {
