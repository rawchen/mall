...
import com.rawchen.common.to.mq.StockDetailTo;
...
import com.rawchen.mall.ware.dao.WareSkuDao;
...
import com.rawchen.mall.ware.feign.OrderFeignService;
import com.rawchen.mall.ware.feign.ProductFeignService;
import com.rawchen.mall.ware.service.WareOrderTaskDetailService;
import com.rawchen.mall.ware.service.WareOrderTaskService;
import com.rawchen.mall.ware.service.WareSkuService;
import com.rawchen.mall.ware.vo.OrderItemVo;
import com.rawchen.mall.ware.vo.OrderVo;
...
public class WareSkuServiceImpl extends ServiceImpl<WareSkuDao, WareSkuEntity> implements WareSkuService {
	...
	public double addStock(Long skuId, Long wareId, Integer skuNum) {
		...
		try {
			...
			System.out.println("com.rawchen.mall.ware.service.impl.WareSkuServiceImpl：远程调用出错");
		}
		// 新增操作
