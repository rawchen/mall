...
import com.rawchen.mall.product.dao.SkuInfoDao;
...
import com.rawchen.mall.product.vo.SeckillInfoVo;
...
public class SkuInfoServiceImpl extends ServiceImpl<SkuInfoDao, SkuInfoEntity> implements SkuInfoService {
	...
	public PageUtils queryPageByCondition(Map<String, Object> params) {
		...
		if(!StringUtils.isEmpty(max)){
			try {
				...
				System.out.println("com.rawchen.mall.product.service.impl.SkuInfoServiceImpl：前端传来非数字字符");
			}
		}
		IPage<SkuInfoEntity> page = this.page(
				new Query<SkuInfoEntity>().getPage(params),
	...
	public SkuItemVo item(Long skuId) throws ExecutionException, InterruptedException {
		...
		CompletableFuture<Void> baseAttrFuture = infoFutrue.thenAcceptAsync(res -> {
			//5 获取spu规格参数信息
			List<SpuItemAttrGroup> attrGroups = attrGroupService.
