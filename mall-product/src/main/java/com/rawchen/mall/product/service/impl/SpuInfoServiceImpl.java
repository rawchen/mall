...
import com.rawchen.common.constant.ProductConstant;
import com.rawchen.common.to.SkuReductionTO;
import com.rawchen.common.to.SpuBoundTO;
...
import com.rawchen.mall.product.dao.SpuInfoDao;
import com.rawchen.mall.product.entity.*;
import com.rawchen.mall.product.feign.CouponFeignService;
import com.rawchen.mall.product.feign.SearchFeignService;
import com.rawchen.mall.product.feign.WareFeignService;
import com.rawchen.mall.product.service.*;
import com.rawchen.mall.product.vo.Attr;
import com.rawchen.mall.product.vo.BaseAttrs;
import com.rawchen.mall.product.vo.Bounds;
import com.rawchen.mall.product.vo.Images;
import com.rawchen.mall.product.vo.Skus;
	...
	public void saveSpuInfo(SpuSaveVo vo) {
		...
		if(skus != null && skus.size() > 0){
			...
			skus.forEach(item -> {
				...
				skuInfoEntity.setSkuDefaultImg(decript.get(0));
