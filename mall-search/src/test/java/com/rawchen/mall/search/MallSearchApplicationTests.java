package com.rawchen.mall.search;

import com.alibaba.fastjson.JSON;
import com.rawchen.mall.search.bean.Account;
import com.rawchen.mall.search.bean.User;
...
//		}
	...
	public void indexTest() throws IOException {
		...
		request.id("2");
		// 第1种方式
//		request.source("userName","rawchen","age","20","gender","男");

		// 第2种方式
		User user = new User();
		user.setUserName("rawchen");
		user.setAge("20");
		user.setGender("男");
